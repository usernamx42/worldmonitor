    ...
    this.ctx.container.innerHTML = `
      <div class="header">
        <div class="header-left">
          ...
          <span class="logo">021LABS.AI</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <span class="credit-link">
            <span class="credit-text">Created by Olzhas T. & Olzhas Y. 2026</span>
          </span>
          <a href="https://github.com/usernamx42/worldmonitor" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
